from ._anvil_designer import Word_editor_copyTemplate
from anvil import *
import anvil.server
import anvil.users
...
class Word_editor_copy(Word_editor_copyTemplate):
    # ====================================================================================
    ...
    def drop_down_font_size_change(self, **e):
        ...
        anvil.js.window.document.execCommand(
            "fontSize", False, mapping.get(size_px, "3")
        )
    ...
    # Color buttons
    def button_red_click(self, **e):
        self.color_change("#FA0000")

    def button_green_click(self, **e):
        self.color_change("#60FA00")

    def button_blue_click(self, **e):
        self.color_change("#00C0FA")

    def button_orange_click(self, **e):
        self.color_change("#FAA300")

    def button_yellow_click(self, **e):
        self.color_change("#F2FA00")
    ...
    def button_align_left_click(self, **e):
        self._apply_alignment("justifyLeft")

    def button_align_center_click(self, **e):
        self._apply_alignment("justifyCenter")

    def button_align_right_click(self, **e):
        self._apply_alignment("justifyRight")

    def button_align_justify_click(self, **e):
    ...
    def timer_2_tick(self, **event_args):
        ...
        if (
            not self._text_is_modified
        ):  # on ne redétecte jamais cat Bt validation visible en forme mère
            # -------- text modified pour la 1ere fois, pour afficher le bt_validation? --------
            if self.text != self._initial_text:
                self._text_is_modified = True
                print(
                    "Word_Editor; Changt de texte détecté, bt validation sera affiché "
                )
    ...
    def button_link_click(self, **event_args):
        ...
        if not saved_range or js.getSelection().toString().strip() == "":
            alert(
                "Sélectionne d'abord un texte à transformer en lien."
            )  # French alert per your requirement
            return
