...
class ItemTemplate32_pr(ItemTemplate32_prTemplate):
    def __init__(self, **properties):
        ...
        items:
                ...
                "date_expiration"    date d'expiration du PR
        """
        ...
        txt0 = self.item['type_stage_txt']+" / "  # le stage
        try:
            txt1 = self.item['stagiaire_email']['nom']+"."+self.item['stagiaire_email']['prenom'][0]+"   /   "    
        except:
            txt1 = self.item['stagiaire_email']['nom']      # si il y a eu un pb en inscription le prénom peut être vide en table Pre_Requis_Stagiaire
            print()
