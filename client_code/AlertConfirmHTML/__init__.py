...
class AlertConfirmHTML(AlertConfirmHTMLTemplate):
    ...
    def __init__(self, titre="Confirmation", contenu="", style="info", large=False, **properties):
        ...
        content_block.add_component(
            RichText(format="restricted_html", content=contenu)
        )
        ...
        anvil.js.window.setTimeout(
            lambda: anvil.js.window.document.activeElement.blur(),
            50
        )
